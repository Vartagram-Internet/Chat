    ...
    var body: some View {
        HStack(alignment: .bottom, spacing: 0) {
            ...
            VStack(alignment: message.user.isCurrentUser ? .trailing : .leading, spacing: 2) {
                ...
                if message.user.isCurrentUser, let status = message.status, isLastMessageRow && positionInUserGroup == .last {
            ...
            .padding(.trailing, message.user.isCurrentUser ? 4: 0)
